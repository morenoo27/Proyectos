...
function editar_grupos(dia, hora, id_usuario, aula, id_aula) {
    ...
    $.ajax({
        ...
        output += "<table id='tabla_editando'>";
        ...
        if (aula == "Sin asignar o sin aula" && filas_tabla.length == 1) {
            ...
            output += `<select onchange='selecciona_grupo("${dia}", "${hora}")' name='grupos_libres' id='grupos_libres'>`;
            ...
            output += "<label>Grupo:</label>";
            output += `<select onchange='selecciona_grupo("${dia}", "${hora}", "${id_aula}")' name='grupos_libres' id='grupos_libres'>`;
        ...
        output += "</form><br/><div id='mensaje'></div>";
...
function selecciona_grupo(dia, hora, id_aula) {
    ...
    let nombreCompletoGrupo = $("#grupos_libres").val().split("-");
...
function add_grupo(dia, hora, id_usuario) {
    ...
    let grupos = $("#grupos_libres").val().split("-");
