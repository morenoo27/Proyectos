...
function cargar_vista_oportuna(usuario) {
    ...
    var html_code = "<div id='saludo'><p>Bienvenido <strong>" + usuario["usuario"] + "</strong> - <button onclick='cerrar_sesion_salto(true);' class='btn btn-dark'>Salir</button></p></div>";
    html_code += "<div id='respuesta'></div><div id='vista_admin'></div><div id='horario'></div><div id='editar_horario'></div>";
