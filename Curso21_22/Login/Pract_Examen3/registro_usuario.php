...
<body>
    ...
    <form action="registro_usuario.php" method="post" enctype="multipart/form-data">
        ...
        <p>
            <label for="foto">Foto (Máx. 500KB): </label><input type="file" name="foto" id="foto" accept="image/*"/><br/>
            <?php
                if(isset($_POST["btnContRegistro"])&& $error_foto)
                {
                    ...
                    elseif(!getimagesize($_FILES["foto"]["tmp_name"]))
                        ...
                        echo "<span class='error'>* Error: el tamaño del archivo seleccionado supera los 500 KB *</span>";
                }
